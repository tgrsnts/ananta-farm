            ...
            <div class="flex bg-white p-8 rounded-3xl">
                ...
                <div class="flex flex-col w-1/2 p-8 gap-8">
                    ...
                    <form id="registerForm" action="" class="flex flex-col gap-2 w-full">
                        ...
                        <button
                            class="mt-2 flex justify-center items-center gap-2 w-full border-2 border-green-normal rounded-md py-1 text-green-normal hover:bg-gray-100 hover:text-additional2"
