<nav id="sidebar" class="transition-all duration-300 fixed left-0 h-full w-64 bg-green-normal z-11 flex flex-col gap-1 pr-12 font-sans text-base font-normal text-blue-gray-700">
    @php
